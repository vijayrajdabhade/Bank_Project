...
// It creates a transfer record, add account entries, and update account's balances within a single databse transaction.
func (store *Store) TransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error) {
	...
	err := store.execTx(ctx, func(q *Queries) error {
		...
		// get account -> update  its account's Balance
